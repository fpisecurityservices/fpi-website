  ...
  return (
    <header style={{
      ...
      <div style={{
        ...
        {/* Logo */}
        <button onClick={() => go('/')} style={{ background: 'none', border: 'none', cursor: 'pointer', padding: 0, display: 'flex', alignItems: 'center', flexShrink: 0 }}>
        ...
        {!isMobile && (
          <div style={{ display: 'flex', alignItems: 'center', gap: 16, flexShrink: 0 }}>
            <a href="tel:8003744316" style={{
              ...
              <Phone size={15} style={{ color: '#006090' }} />
              (800) 374-4316
            </a>
