export const SERVICES_DATA = [
  {
    ...
    shortDesc: "Professional security guard services — armed and unarmed officers licensed under Chapter 493, deployed with live GPS dispatch and real-time reporting for your property.",
    fullDesc: "FPI Security Services provides professional security guard services across South Florida and Texas. Every officer is background-checked, licensed under Florida Statute Chapter 493, and trained to your specific post orders. From armed security guard services for high-risk facilities to unarmed commercial guards for office buildings and retail centers, we provide 24/7 security coverage backed by our proprietary client portal with live GPS dispatch and real-time incident reporting.",
    tags: ['On-Site', 'Armed/Unarmed', 'Licensed', '24-Hour Service'],
    bullets: ['Licensed under Florida Statute Chapter 493', 'Comprehensive background checks on every officer', 'Armed and unarmed security guard services', 'Live GPS dispatch via proprietary client portal', 'Real-time incident reporting with photo documentation', 'Rapid deployment for South Florida and Texas properties'],
