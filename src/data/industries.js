export const INDUSTRIES_DATA = [
  ...
  },
  {
    ...
    shortDesc: 'Retail environments face constant loss prevention challenges and need security that deters without disrupting customers. FPI officers are trained in hospitality-forward security — professional, visible, and effective.',
  ...
  },
  {
    ...
    shortDesc: 'CA, FL, and TX account for 54% of all U.S. cargo theft (NICB, 2025) — warehouses need more than a guard at the gate. FPI combines patrol, autonomous surveillance, and 24/7 SOC monitoring for industrial footprints.',
