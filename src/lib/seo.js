// Central per-route metadata, consumed by Next.js `metadata` exports.
// Replaces the old scripts/generate-meta.js build step and the react-helmet <SEO> component.
...
export const SEO_PAGES = {
  ...
  '/industries/hoa-residential-security': {
    title: 'Property Security Services | HOAs & Residential | FPI',
    ...
    ogDescription: 'GPS-verified patrol logs, a 24/7 client portal, and licensed officers — property security HOA boards can actually document.',
    canonical: 'https://www.fpisecurity.com/industries/hoa-residential-security',
  },
  '/industries/construction-site-security': {
    ...
    canonical: 'https://www.fpisecurity.com/industries/construction-site-security',
  },
  '/industries/commercial-office-building-security': {
    ...
    canonical: 'https://www.fpisecurity.com/industries/commercial-office-building-security',
  },
  '/industries/healthcare-security-services': {
    ...
    canonical: 'https://www.fpisecurity.com/industries/healthcare-security-services',
  },
  '/industries/car-dealership-security': {
...
// Build a Next.js Metadata object for a given route key.
export function buildMetadata(route) {
  const p = SEO_PAGES[route];
  if (!p) return {};
  return {
    title: p.title,
